        ...
        <div className="max-w-xl mx-auto">
          <Card className="bg-card/60 backdrop-blur-sm border border-border shadow-xl">
            <CardContent className="p-8 space-y-4 text-center">
              ...
              <h1 className="text-2xl font-bold tracking-tight">Coursera lectures</h1>
              <p className="text-sm text-muted-foreground">
                No Coursera capture yet. Open a Coursera lecture, click the
                BridgeAI icon, and choose <span className="font-medium">Save Lecture to Dashboard</span>.
              </p>
...
export default function CourseraCoursePage() {
  return (
