        ...
        <div className="max-w-xl mx-auto">
          <Card className="bg-card/60 backdrop-blur-sm border border-border shadow-xl">
            <CardContent className="p-8 space-y-4 text-center">
              ...
              <h1 className="text-2xl font-bold tracking-tight">Upload not found</h1>
              <p className="text-sm text-muted-foreground">
                We couldn&apos;t find this PDF or audio upload. Re-upload from the
                dashboard.
              </p>
...
export default function DocumentCoursePage() {
  return (
