        ...
        <div className="max-w-xl mx-auto">
          <Card className="bg-card/60 backdrop-blur-sm border border-border shadow-xl">
            <CardContent className="p-8 space-y-4 text-center">
              ...
              <h1 className="text-2xl font-bold tracking-tight">Echo360 lectures</h1>
              <p className="text-sm text-muted-foreground">
                No Echo360 capture yet. Open a lecture in Echo360, click the
...
export default function Echo360CoursePage() {
  return (
